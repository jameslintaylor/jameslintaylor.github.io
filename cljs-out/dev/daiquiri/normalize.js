...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__12979_SHARP_){
return (((p1__12979_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__12979_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__12980,cljs.core.cst$kw$class,daiquiri.normalize.normalize_class);
} else {
return G__12980;
}
});
...
var len__4736__auto___12983 = arguments.length;
var i__4737__auto___12984 = (0);
while(true){
if((i__4737__auto___12984 < len__4736__auto___12983)){
args__4742__auto__.push((arguments[i__4737__auto___12984]));

var G__12985 = (i__4737__auto___12984 + (1));
i__4737__auto___12984 = G__12985;
continue;
} else {
}
break;
...
var G__12982 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12982,cljs.core.cst$kw$class,cljs.core.vec(classes));
} else {
return G__12982;
}
} else {
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq12981){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12981));
}));
...
var vec__12988 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null),cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12988,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12988,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__12986_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__12986_SHARP_))){
return p1__12986_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__12987_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__12987_SHARP_))){
return daiquiri.normalize.strip_css(p1__12987_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__12992){
var vec__12993 = p__12992;
var seq__12994 = cljs.core.seq(vec__12993);
var first__12995 = cljs.core.first(seq__12994);
var seq__12994__$1 = cljs.core.next(seq__12994);
var tag = first__12995;
var content = seq__12994__$1;
...
var vec__12996 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12996,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12996,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12996,(2),null);
var tag_attrs = (function (){var G__12999 = cljs.core.PersistentArrayMap.EMPTY;
var G__12999__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12999,cljs.core.cst$kw$id,id):G__12999);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12999__$1,cljs.core.cst$kw$class,class$);
} else {
return G__12999__$1;
}
})();
